...
class PickupTest extends TestCase {
  ...
  public function testInvalidCreate() {
    try {
      ...
      $objectId = "asdfoansdofnandfpapsdfnpasdpnf";
      $pickup = self::getDefaultPickup($objectId, $invalid_account_id, self::getFromAddress());
    } catch (Exception $e) {
  ...
  private function getInternationalShipment() {
    ...
    $customsDeclaration = CustomsDeclaration::create(array(
          'exporter_reference' => '',
          'importer_reference' => '',
    ...
    return Shipment::create(
        array(
              "object_purpose" => "PURCHASE",
              'address_from' => Address::create(self::getFromAddress()),
              'address_to' => Address::create(self::getToAddress()),
