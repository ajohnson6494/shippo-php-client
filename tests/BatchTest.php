...
class BatchTest extends TestCase {
  public function testCreate() {
    ...
    $this->mockRequest(
        ...
        '/batches/',
        $data,
        $this->batchCreateResponse($carrier, $metadata)
    );
  ...
  public function testRetrieve() {
    ...
    $this->mockRequest(
        ...
        '/batches/' . $batch_id,
        array(),
        $this->batchRetrieveResponse($batch_id)
    );
    $batch = Batch::retrieve($batch_id);
  ...
  public function testAdd() {
    ...
    $this->mockRequest(
        'POST',
        '/batches/' . $batch_id . '/add_shipments/',
        $data,
        $this->batchAddResponse($batch_id)
    );
    $batch = Batch::add($batch_id, $data);
    $this->assertEquals($batch->object_id, $batch_id);
  }
  ...
  public function testRemove() {
    ...
    $this->mockRequest(
        'POST',
        '/batches/' . $batch_id . '/remove_shipments/',
        $data,
        $this->batchRemoveResponse($batch_id)
    );
    $batch = Batch::remove($batch_id, $data);
    $this->assertEquals($batch->object_id, $batch_id);
  }
  ...
  public function testPurchase() {
    ...
    $this->mockRequest(
        'POST',
        '/batches/' . $batch_id . '/purchase/',
        array(),
        $this->batchPurchaseResponse($batch_id)
    );
    $batch = Batch::purchase($batch_id);
    $this->assertEquals($batch->object_id, $batch_id);
  }
