...
class ManifestTest extends TestCase {
  public function testCreate() {
    ...
    $this->mockRequest(
        ...
        '/manifests/',
        $data,
        $this->manifestCreateResponse($carrier_account, $shipment_date)
    );
  ...
  public function testRetrieve() {
    ...
    $this->mockRequest(
        ...
        array(),
        $this->manifestRetrieveResponse($manifest_id)
    );
    $retrieve_manifest = Manifest::retrieve($manifest_id);
    $this->assertEquals($retrieve_manifest->object_id, $manifest_id);
  }

  public function testListAll() {
    $list = Manifest::all(array(
          'results' => '3',
          'page' => '1'
      ));
