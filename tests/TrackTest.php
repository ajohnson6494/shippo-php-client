...
class TrackTest extends TestCase {
  public function testGet_Status() {
    ...
    $this->mockRequest(
        'GET',
        '/tracks/' . $carrier . '/' . $tracking_id,
        array(),
        $this->trackingResponse($tracking_id, $carrier, null)
    );
    $status = Track::get_status(array(
          'id' => $tracking_id,
          'carrier' => $carrier
      ));
  ...
  public function testCreate() {
    ...
    $this->mockRequest(
        ...
        '/tracks/',
        $params,
        $this->trackingResponse($tracking_id, $carrier, $metadata)
    );
    $webhook_response = Track::create($params);
