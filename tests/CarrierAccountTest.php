...
use Exception;
use Shippo\CarrierAccount;

class CarrierAccountTest extends TestCase {
  public function testListAll() {
    $list = CarrierAccount::all();
  ...
  public function testRetrieve() {
    ...
    $this->mockRequest(
        ...
        array(),
        $this->carrierRetrieveResponse($account_id)
    );

    $carrier_account = CarrierAccount::retrieve($account_id);
  ...
  public function testInvalidRetrieve() {
    ...
    try {
      CarrierAccount::retrieve($invalid_account_id);
  ...
  public function testUpdate() {
    ...
    $this->mockRequest(
        ...
        '/carrier_accounts/' . $account_id,
        array('active' => $active),
        $this->carrierUpdateResponse($account_id, $carrier, $active)
    );
    $updated_account = CarrierAccount::update(
        $account_id,
        array('active' => $active)
    );
  ...
  private function createTestAccount($account_id = null) {
    ...
    return CarrierAccount::create($parameters);
  }
