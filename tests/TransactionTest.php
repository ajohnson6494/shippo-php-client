...
class TransactionTest extends TestCase {
  public function testCreate() {
    ...
    $this->mockRequest(
        ...
        '/transactions/',
        $data,
        $this->transactionCreateResponse($rate, $metadata)
    );
  ...
  public function testRetrieve() {
    ...
    $this->mockRequest(
        ...
        array(),
        $this->transactionRetrieveResponse($transaction_id)
    );
    $retrieve_transaction = Transaction::retrieve($transaction_id);
    $this->assertEquals($retrieve_transaction->object_id, $transaction_id);
  }

  public function testListAll() {
    $list = Transaction::all(array(
          'results' => '3',
          'page' => '1'
      ));
